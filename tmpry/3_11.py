...
class CVEDataProcessor:
    def __init__(self, database_file="/home/escan/aaaa/cvebintool/data.db"):
    ...
    def extract_severity_info(self, cve_item):
        ...
        impact = cve_item.get("impact", {}).get("baseMetricV2", {})
        severity = impact.get("severity", "Unknown")
        score = impact.get("cvssV2", {}).get("baseScore", 0)
        cvss_version = impact.get("cvssV2", {}).get("version", 0.0)
        cvss_vector = impact.get("cvssV2", {}).get("vectorString", "Unknown")
